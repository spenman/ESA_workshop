...
predictors$temperature_std <- scaledat(predictors$temperature_c)

predictors$precipitation_std <- scaledat(predictors$precipitation_mm)

predictors$tree_cover_std <- scaledat(predictors$tree_cover_pc)

predictors$flowering_std <- scaledat(predictors$flowering_pc)
...
model_sp1b<- FUNglm(data_set$occ_sp1)

model_sp2<- FUNglm(data_set$occ_sp2)

model_sp3<- FUNglm(data_set$occ_sp3)
...
FUNplot(model_sp1, "Species 1", col="green")
FUNplot(model_sp2, "Species 2", col="blue")
FUNplot(model_sp3, "Species 3", col="red")
